  ...
  render () {
    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <div className='lead-paragraph'>
          <div className='video-juntas'>
            <div className='embed-responsive embed-responsive-1by1'>
              <iframe width="560" height="560" className='embed-responsive-item' src="https://www.youtube.com/watch?v=cBk91pWoBc0&feature=emb_title" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
          </div>
        </div>
